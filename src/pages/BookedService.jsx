...
const BookedService = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      axios
        .get(
          `https://ass-10-server-umber.vercel.app/bookedservices?email=${email}`,
          {
  ...
  //     axios
  //         .patch(`https://ass-10-server-umber.vercel.app/bookedservices/${id}`, { status: newStatus })
  //         .then((res) => {
  ...
  return (
    <div>
      ...
      <h1 className="text-center text-3xl font-bold py-10">Services</h1>
