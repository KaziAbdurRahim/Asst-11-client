...
const AllServices = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Games in service</title>
      </Helmet>

      <h1 className="text-center text-3xl font-bold py-10">Search Games </h1>
          ...
          <div className="mb-8 mx-auto">
            ...
            {filteredServices.length === 0 ? (
              ...
              filteredServices.map((service) => (
                <div
                  key={service._id}
                  className=" flex justify-between gap-10 mb-1 border p-2 px-4"
                >
                  <p>{service.name}</p>
      ...
      <h1 className="text-center text-3xl font-bold py-10">All Car Games</h1>
