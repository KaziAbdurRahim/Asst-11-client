...
const Navbar = () => {
  ...
  const links = [
    ...
    <li key="all-service">
      <Link to="/allservice" onClick={() => setLoading(true)}>
        All games
      </Link>
    </li>,
    user && (
      <li key="add-service">
        <Link to="/add-service">Add Games</Link>
      </li>
    ),
    user && (
      <li key="manage-service">
        <Link to="/manage-service">My Gamess</Link>
      </li>
    ),
    user && (
      <li key="booked-service">
        <Link to="/booked-service">My Bookings</Link>
      </li>
    ),
    user && (
      <li key="services-todo">
        <Link to="/services-todo">Service To Do</Link>
      </li>
    ),
    <li key="faq">
      ...
      <div className="navbar-start">
        ...
        <Link to="/">
          <div className="btn btn-ghost text-2xl  italic flex items-center pl-0 md:pl-4 gap-2 ">
            ...
            <span className="text-center sm:block font-bold">GameHouse</span>
          </div>
        </Link>
      </div>
      ...
      <div className="navbar-end ">
        {user ? (
          <div className="dropdown dropdown-end">
            ...
            >
              <li>
                <button className="btn-disabled">{user.displayName}</button>
              </li>
              <li>
