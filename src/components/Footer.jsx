  ...
  return (
    <footer className="footer sm:footer-horizontal bg-neutral text-neutral-content p-10 flex flex-wrap justify-evenly">
      ...
      <nav>
        ...
        <a className="link link-hover" href="#">Solutions</a>
        <a className="link link-hover" href="#">Insights</a>
      </nav>
      <nav>
        <h6 className="footer-title">About</h6>
        <a className="link link-hover" href="#">Who We Are</a>
        <a className="link link-hover" href="#">Contact Us</a>
        <a className="link link-hover" href="#">Careers</a>
        <a className="link link-hover" href="#">Media</a>
      </nav>
      <nav>
